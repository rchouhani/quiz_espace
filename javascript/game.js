...
const containerProgressBarTimer = document.querySelector(
...
boutonSuivant.addEventListener("click", function () {
  ...
  if (textIndex >= quiz_espace.questions.length) {
    ...
    scoreBonnesReponses.innerText =
      "Bonnes réponses : " + scoreIndex + " / " + quiz_espace.questions.length;
...
function correctAnswerScore(buttonIdClicked, correctAnswer) {
  ...
  if (scoreIndex <= 2) {
    ...
    message.innerText =
      "Excellent ! tu es prêt pour la prochaine expédition sur Mars !! 🥳";
  } else {
